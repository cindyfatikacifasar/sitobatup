...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Resource Tanaman (Menggunakan ID secara default)
...
Route::prefix('pj')->name('pj.')->middleware(['auth', 'role:penanggungjawab'])->group(function () {
    ...
    // Laporan
    Route::get('/laporan/tanaman', [PjLaporan::class, 'tanaman'])->name('laporan.tanaman');
    Route::get('/laporan/pengunjung', [PjLaporan::class, 'pengunjung'])->name('laporan.pengunjung');
    Route::get('/laporan/export', [PjLaporan::class, 'export'])->name('laporan.export');
    Route::get('/laporan-berita', [PjLaporan::class, 'berita'])->name('laporan.berita');
    Route::get('/laporan-berita/cetak', [PjLaporan::class, 'cetakBerita'])->name('laporan.berita.cetak');
    Route::get('/laporan-galeri', [PjLaporan::class, 'galeri'])->name('laporan.galeri');
    Route::get('/laporan-galeri/cetak', [PjLaporan::class, 'cetakGaleri'])->name('laporan.galeri.cetak');

    // Saran PJ
    Route::get('/saran', [PjSaran::class, 'index'])->name('saran.index');
    Route::get('/saran/create', [PjSaran::class, 'create'])->name('saran.create');
    Route::post('/saran', [PjSaran::class, 'store'])->name('saran.store');
    Route::get('/saran/{id}', [PjSaran::class, 'show'])->name('saran.show');
    Route::delete('/saran/{id}', [PjSaran::class, 'destroy'])->name('saran.destroy');
