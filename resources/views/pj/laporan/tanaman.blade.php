                ...
                <div class="modal-body p-5">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="rentang_cetak" class="form-select form-select-lg" style="border-radius: 8px; font-size: 0.95rem;">
                            <option value="semua">✨ Semua Data Tanaman</option>
                    ...
                    <div class="text-center my-4 position-relative">
                        <hr>
                        <span class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted small fw-bold">ATAU ATUR TANGGAL</span>
                    </div>
