        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    @if($user->foto)
                        <img src="{{ Storage::url($user->foto) }}" class="rounded-circle mb-2" width="90" height="90" style="object-fit:cover;border:3px solid #2d8a4e;">
                    @else
                        <div style="width:90px;height:90px;background:#e8f5e9;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:2.5rem;margin:0 auto 8px;border:3px solid #2d8a4e;">👤</div>
                    @endif
                ...
                <form method="POST" action="{{ route('admin.profil.update') }}" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-hijau mt-4 px-4"><i class="bi bi-save me-1"></i>Simpan Perubahan</button>
                </form>
            </div>
        </div>
    </div>
